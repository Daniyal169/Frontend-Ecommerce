...
function Footer() {
    return (
        <footer className="w-full bg-bgColor py-8">
            ...
            <hr className="my-4" />
            <div className="mx-auto max-w-6xl items-center justify-between px-4 md:flex lg:px-0 border-t-2 ">
                <div className="inline-flex items-center">
                    <img src={logo} alt="" height={50} width={200} />
                </div>
                <div className="mt-4 md:mt-0">
                    <p className="text-sm font-medium text-gray-500">© 2024 MDS. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
